...
public class ItemIngot extends ItemJATAWithMetadata
{
    public IIcon[] icons = new IIcon[11];
    private String[] names = {"aluminum", "bronze", "chromium", "cobalt", "copper", "impuretitanium", "lead", "silver", "tin",
            "titanium", "uranium"};

    public ItemIngot()
    {
        super();
        setUnlocalizedName(Names.INGOT);
        setHasSubtypes(true);
    }
    ...
    public void registerIcons(IIconRegister register)
    {
        for (int i = 0; i < icons.length; i++)
            icons[i] = register.registerIcon(Reference.MODID + ":" + Names.INGOT + "_" + names[i]);
    }
    ...
    public String getUnlocalizedName(ItemStack stack)
    {
        switch (stack.getItemDamage())
        {
            ...
            case 10:
                return getUnlocalizedName() + "_uranium";
            default:
